...
public class ConcurrentStateMachine
{
    ...
    public ConcurrentStateMachine(string name, IState rootState, Action<string> debugLog, Action onMessagesAvailable, StateMachine.LogFlags logFlags = StateMachine.LogFlags.None)
    {
